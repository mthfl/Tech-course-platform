...
(1, 1, 'Quiz: Conceitos Básicos do Git', 'Teste seus conhecimentos sobre os fundamentos do Git', 'questionario', '{\"perguntas\": [{\"pergunta\": \"O que é Git?\", \"tipo\": \"multipla_escolha\", \"opcoes\": [{\"texto\": \"Um sistema de controle de versão distribuído\", \"correta\": true}, {\"texto\": \"Um editor de texto\", \"correta\": false}, {\"texto\": \"Um banco de dados\", \"correta\": false}, {\"texto\": \"Uma linguagem de programação\", \"correta\": false}], \"explicacao\": \"Git é um sistema de controle de versão distribuído\"}, {\"pergunta\": \"Qual comando inicializa um repositório Git?\", \"tipo\": \"multipla_escolha\", \"opcoes\": [{\"texto\": \"git init\", \"correta\": true}, {\"texto\": \"git start\", \"correta\": false}, {\"texto\": \"git create\", \"correta\": false}, {\"texto\": \"git new\", \"correta\": false}], \"explicacao\": \"git init cria um novo repositório Git\"}], \"config\": {\"tempo_limite\": 30, \"tentativas\": 3}}', 1, 1, '2025-11-06 14:58:58'),
(2, 1, 'Exercício: Primeiro Repositório', 'Crie seu primeiro repositório Git', 'exercicio', '{\"instrucoes\": \"Crie um repositório local, adicione um arquivo README.md e faça o primeiro commit\", \"entregaveis\": [\"README.md\"], \"dicas\": [\"Use git init para iniciar\", \"git add para adicionar arquivos\", \"git commit para confirmar mudanças\"]}', 2, 1, '2025-11-06 14:58:58'),
(3, 2, 'Quiz: Branches e Merge', 'Avalie seu entendimento sobre branches', 'questionario', '{\"perguntas\": [{\"pergunta\": \"Qual comando cria uma nova branch?\", \"tipo\": \"multipla_escolha\", \"opcoes\": [{\"texto\": \"git branch nova-branch\", \"correta\": true}, {\"texto\": \"git create branch nova-branch\", \"correta\": false}, {\"texto\": \"git new branch nova-branch\", \"correta\": false}, {\"texto\": \"git make branch nova-branch\", \"correta\": false}], \"explicacao\": \"git branch nome-da-branch cria uma nova branch\"}, {\"pergunta\": \"O que é um merge conflict?\", \"tipo\": \"multipla_escolha\", \"opcoes\": [{\"texto\": \"Quando há alterações conflitantes no mesmo arquivo\", \"correta\": true}, {\"texto\": \"Quando o repositório está vazio\", \"correta\": false}, {\"texto\": \"Quando não há internet\", \"correta\": false}, {\"texto\": \"Quando se usa git pull\", \"correta\": false}], \"explicacao\": \"Conflito de merge ocorre quando há alterações conflitantes no mesmo arquivo\"}], \"config\": {\"tempo_limite\": 25, \"tentativas\": 2}}', 1, 1, '2025-11-06 14:58:58'),
(4, 2, 'Projeto: Trabalhando com Branches', 'Pratique criação e merge de branches', 'projeto', '{\"instrucoes\": \"Crie uma branch feature, desenvolva uma funcionalidade e faça merge com a main\", \"entregaveis\": [\"branch-feature\", \"merge-request\"], \"critérios_avaliacao\": [\"Branch criada corretamente\", \"Merge realizado sem conflitos\", \"Histórico organizado\"]}', 2, 1, '2025-11-06 14:58:58');
...
(1, 'Matheus Felix', 'matheus.dev91@gmail.com', '$2y$10$nbtrumXfdUGNSJIQZbrtU.VqAr0x4hqF.RgO.00lTgi6ikQxjY9Eq', '2025-11-05 23:48:40', 'iniciante', 60, 0, 1);
